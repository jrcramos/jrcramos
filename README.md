...
As a bioprocess engineer and computational biologist, my work sits at the **intersection of biology, data science, and systems optimization**. My research focuses on:
- **Hybrid deep modeling** of bioprocesses combining mechanistic knowledge with deep neural networks
- **In silico media/feed design** using hybrid semi-parametric modeling (contributing to >50% gains in mammalian cell productivity)
- **Mechanistic dynamical models** of cell growth, central carbon metabolism, and virus production
- Statistical modeling, machine learning, and dynamic systems design
...
[![ORCID](https://img.shields.io/badge/ORCID-A6CE39?logo=orcid&logoColor=white)](https://orcid.org/0000-0002-6832-6774)
...
- **Pinto J., Ramos J.R.C., Costa R.S., Oliveira R.** (2023) [A General Hybrid Modeling Framework for Systems Biology Applications](https://doi.org/10.3390/ai4010014) - *AI*

- **Pinto J., Ramos J.R.C., Costa R.S., Rossell S., Dumas P., Oliveira R.** (2023) [Hybrid deep modeling of a CHO-K1 fed-batch process](https://dx.doi.org/10.3389/fbioe.2023.1237963) - *Frontiers in Bioengineering*

- **Pinto J., Ramos J.R.C., Costa R.S., Oliveira R.** (2023) [Hybrid Deep Modeling of a GS115 (Mut+) Pichia pastoris Culture](https://doi.org/10.3390/fermentation9070643) - *Fermentation*
...
<!-- Profile inspired by the GitHub community -->
